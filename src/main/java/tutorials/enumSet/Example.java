...
public class Example {
    public static void main(String[] args)
    {
        ...
        EnumSet<Courses> final_enumset = copyOf(samplecollection);
        // Display the EnumSet
        ...
        EnumSet<Courses> example_set = allOf(Courses.class);
        ...
        EnumSet<Courses> final_set = copyOf(example_set);
        ...
        complement_set = complementOf(sample_set);
        ...
        //noneOf method
        // Create empty set
        EnumSet<Courses> none_example_set = noneOf(Courses.class);
